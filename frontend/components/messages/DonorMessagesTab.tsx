          ...
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-emerald-100 text-sm">
                ...
                {viewMode === 'inbox' && `${messages.filter(m => m.status === 'unread').length} unread`}
                {viewMode === 'sent' && `${messages.length} messages`}
                {viewMode === 'conversation' && 'Donation coordination'}
              </p>
            </div>
          </div>
...
// Enhanced Conversations List View
const EnhancedConversationsView: React.FC<{
    ...
    return (
      <div className="p-8 text-center text-gray-500 h-full flex items-center justify-center">
        <div>
          ...
          <p className="text-sm mt-2">People interested in your donations will appear here</p>
        </div>
      </div>
    );
  }
...
// Enhanced Messages List View
const EnhancedMessagesListView: React.FC<{
  messages: Message[];
    ...
    return (
      <div className="p-8 text-center text-gray-500 h-full flex items-center justify-center">
        <div>
          ...
          <p className="text-lg font-medium">No {viewMode === 'inbox' ? 'responses' : 'sent messages'} yet</p>
...
const EnhancedConversationView: React.FC<{
  messages: Message[];
  currentUserId: number;
  currentUser: any;
  otherUser: any;
    ...
    <div className="flex flex-col h-full">
      ...
      <div className="px-4 py-3 bg-blue-50 border-t border-blue-100">
        <p className="text-sm text-blue-700">
          <strong>Tip:</strong> Share your contact details, availability, and pickup/delivery preferences to coordinate your donation.
        </p>
      </div>
