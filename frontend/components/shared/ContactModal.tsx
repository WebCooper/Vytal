// Updated ContactModal.tsx with simple success state
'use client';
import React, { useState } from 'react';
import { motion, AnimatePresence } from 'framer-motion';
import { FaTimes, FaPhone, FaEnvelope, FaUser, FaPaperPlane, FaCheckCircle } from 'react-icons/fa';
...
const ContactModal: React.FC<ContactModalProps> = ({ isOpen, onClose, post, currentUserId }) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const messageData: CreateMessageRequest = {
        ...
        post_id: post.id,
        subject: `Interest in: ${post.title}`,
            ...
            {showSuccess ? (
              ...
              <div className="p-12 text-center">
                ...
                <p className="text-gray-600 mb-6">
                  Your message has been sent to {post.user.name}. They will receive your contact information and can reach out to you directly.
                </p>
